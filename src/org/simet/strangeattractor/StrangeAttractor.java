...
class settings {
    ...
    settings(int i) {
        ...
        case 5:
            wsp[0] = -1.1451230657280833;
            wsp[1] = 0.06939708960723912;
            wsp[2] = -0.2493128262387131;
            wsp[3] = 0.9560195802528695;
            wsp[4] = -0.5124752764931397;
            wsp[5] = 0.6323701432242739;
            wsp[6] = -0.513691747463212;
            wsp[7] = -1.1180920771731644;
            wsp[8] = -0.636414811137721;
            wsp[9] = -1.0852065249324512;
            wsp[10] = -0.4875226940656493;
            wsp[11] = 0.9765339081336839;
            size[0] = -1.8;
            size[1] = -0.1;
            size[2] = -0.7;
            size[3] = 0.3;
            ...
            break;
        case 6:
            wsp[0] = -1.115211462916893;
            wsp[1] = 0.7424245056605341;
            wsp[2] = 0.4125049983667717;
            wsp[3] = 0.4691975839623155;
            wsp[4] = 0.5490951772379193;
            wsp[5] = 0.33696426049269035;
            wsp[6] = 0.4266331063945519;
            wsp[7] = 0.18601267787907094;
            wsp[8] = -0.9164376801011744;
            wsp[9] = 0.9276650652896132;
            wsp[10] = 1.1140415271969448;
            wsp[11] = 0.5644034483053486;
            size[0] = -3.0;
            size[1] = 1.0;
            size[2] = -2.5;
            size[3] = 1.2;
            ...
            break;
        case 7:
            wsp[0] = 1.1670816425463373;
            wsp[1] = -0.28397828539706227;
            wsp[2] = -1.0941940662396201;
            wsp[3] = 0.1632670806374057;
            wsp[4] = 0.1928148626698465;
            wsp[5] = -0.43277674205520056;
            wsp[6] = 0.6637482694746559;
            wsp[7] = -0.9439554352689297;
            wsp[8] = 0.2013270927534938;
            wsp[9] = -0.7884345378617503;
            wsp[10] = -0.6803068497471002;
            wsp[11] = -0.17683290115065065;
            size[0] = -3.0;
            size[1] = 3.0;
            size[2] = -3.25;
            size[3] = 2.25;
            ...
            break;
        case 8:
            wsp[0] = -0.1285301942922168;
            wsp[1] = 0.871911941483636;
            wsp[2] = -0.6412794510350659;
            wsp[3] = -0.07127750233182084;
            wsp[4] = -0.06340370587368094;
            wsp[5] = 0.5853038062060811;
            wsp[6] = -0.8339558764981878;
            wsp[7] = -0.6336478074227624;
            wsp[8] = 0.8058401784426745;
            wsp[9] = 1.0127595858679352;
            wsp[10] = -1.1590989275659034;
            wsp[11] = 0.6399125645455541;
            size[0] = -1.5;
            size[1] = 2.0;
            size[2] = -2.0;
            size[3] = 1.5;
            ...
            break;
        case 9:
            wsp[0] = 0.9229986706404867;
            wsp[1] = -0.0352903544617269;
            wsp[2] = -0.42951698717455256;
            wsp[3] = -0.05647609538791265;
            wsp[4] = -0.3025440292088115;
            wsp[5] = -0.6432793251889626;
            wsp[6] = -0.5507843961690061;
            wsp[7] = 1.132102941918659;
            wsp[8] = 0.9980280895177402;
            wsp[9] = 0.6466387241165636;
            wsp[10] = -0.13107215905311476;
            wsp[11] = 0.636606795882479;
            size[0] = -2.2;
            size[1] = 1.2;
            size[2] = -1.5;
            size[3] = 2.0;
            ...
            break;
        case 10:
            wsp[0] = 0.5647594364542792;
            wsp[1] = -0.1811091915223364;
            wsp[2] = 0.7414159597385277;
            wsp[3] = -1.141135697741246;
            wsp[4] = -0.6474582829184446;
            wsp[5] = 0.10644510770372984;
            wsp[6] = -0.22614136387167905;
            wsp[7] = -0.44074107561290443;
            wsp[8] = 0.7917470769840229;
            wsp[9] = 0.6030840860324482;
            wsp[10] = -0.9254723577758663;
            wsp[11] = -0.7211639258863936;
            size[0] = -0.5;
            size[1] = 1.6;
            size[2] = -0.8;
            size[3] = 1.0;
            ...
            break;
        case 11:
            wsp[0] = 0.5604373288711066;
            wsp[1] = 0.7169716129512371;
            wsp[2] = -0.47004284581011524;
            wsp[3] = -1.0625257569277806;
            wsp[4] = -1.093472980177119;
            wsp[5] = 0.5430674652579528;
            wsp[6] = 0.0028096595786575307;
            wsp[7] = -1.1659071171253244;
            wsp[8] = 0.8960763731574792;
            wsp[9] = 0.36847399559541927;
            wsp[10] = -0.7635518851889538;
            wsp[11] = 0.31336137082540616;
            size[0] = -1.5;
            size[1] = 2.0;
            size[2] = -0.9;
            size[3] = 2.2;
            ...
            break;
        case 12:
            wsp[0] = -1.016536188798188;
            wsp[1] = 0.47903638168399243;
            wsp[2] = 0.9119786702284245;
            wsp[3] = 1.1567157998381823;
            wsp[4] = -0.4131940340780066;
            wsp[5] = 0.4654062378065422;
            wsp[6] = -0.7039554401584929;
            wsp[7] = 0.2086005546837637;
            wsp[8] = 0.1165498269473384;
            wsp[9] = -0.6304650006755189;
            wsp[10] = -0.10489537544636796;
            wsp[11] = 0.20886955773891613;
            size[0] = -1.5;
            size[1] = 1.5;
            size[2] = -1.5;
            size[3] = 1.5;
            ...
            break;
        case 13:
            wsp[0] = 0.562077149311925;
            wsp[1] = 0.4679449578977768;
            wsp[2] = -0.44731716081850503;
            wsp[3] = -0.3417190348105593;
            wsp[4] = -0.9004375818771004;
            wsp[5] = -0.08815369930322481;
            wsp[6] = 0.7676255076324792;
            wsp[7] = 0.9790767732476817;
            wsp[8] = -0.4174628756266767;
            wsp[9] = 1.105847231406292;
            wsp[10] = -0.5524330422419773;
            wsp[11] = -0.6815160593061547;
            size[0] = -2.0;
            size[1] = 2.0;
            size[2] = -2.2;
            size[3] = 2.0;
...
public class StrangeAttractor extends Applet implements ActionListener, ItemListener {
    ...
    void nextPoint() {
        ...
        double tmpX;
        double tmpY;
        tmpX = s.wsp[0] + s.wsp[1] * p.getX() + s.wsp[2] * p.getX() * p.getX() + s.wsp[3] * p.getX() * p.getY() + s.wsp[4] * p.getY() + s.wsp[5] * p.getY()
                * p.getY();
        tmpY = s.wsp[6] + s.wsp[7] * p.getX() + s.wsp[8] * p.getX() * p.getX() + s.wsp[9] * p.getX() * p.getY() + s.wsp[10] * p.getY() + s.wsp[11] * p.getY()
                * p.getY();
    ...
    public void actionPerformed(ActionEvent e) {
        if (e.getSource() == button) {
            ...
            for (int i = 0; i < 5000; ++i) {
                nextPoint();
                if (i > 100) {
                    if (p.getX() < size[0] || Math.abs(size[0]) < 0.000001)
                        size[0] = p.getX();
                    else if (p.getX() > size[1] || Math.abs(size[1]) < 0.000001)
                        size[1] = p.getX();
                    if (p.getY() < size[2] || Math.abs(size[2]) < 0.000001)
                        size[2] = p.getY();
                    else if (p.getY() > size[3] || Math.abs(size[3]) < 0.000001)
                        size[3] = p.getY();
                }
            }
            for (int i = 0; i < 4; i++) {
